...
class WsClient(WebSocketClient):
    def opened(self):
        pass
        self.send('{"t":"msg_inputting", "to_id":"59ca0b46ca714306705996dc"}')
...
if __name__ == '__main__':
    try:
        ...
        ws = WsClient(url, protocols=['chat'], headers=[('X-Cookie',
                                                         'u="_2|1:0|10:1506413382|1:u|32:NTljYTBiNDZjYTcxNDMwNjcwNTk5NmRj|6c5a31e149f297ffdc10190f9bea527ee72be807723725279a4e2104e1d3c580"'),
