...
from lib import log
from model.MeError import ERR_INVALID
...
def get_specific_count(userid):
    ...
    query = {'$or': [{'name': l[0] + '_' + userid}, {'name': l[1] + '_' + userid}, {'name': l[2] + '_' + userid},
                     {'name': l[3] + '_' + userid}, {'name': l[4] + '_' + userid}, {'name': l[5] + '_' + userid}]}
